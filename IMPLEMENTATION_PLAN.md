...
- [ ] 1. Baseline and regression integration: fresh-source provenance and full baseline; nine review probe groups converted to desired-behavior assertions.
- [ ] 2. Graph/call correctness: typed-edge/traversal tests, conservative resolution, incremental/fresh equivalence and query-order permutations.
- [ ] 3. Automatic freshness: actual MCP edit/create/delete/rename/config/error/timeout lifecycle, coherent cached results without refresh.
- [ ] 4. Language/context parity: API-preserving skeleton fixtures, structured result and exact delivered spans/budgets.
- [ ] 5. Scale/retrieval: deterministic 10k fixture plus pinned public repo, frozen comparative sample and reproducible results.
- [ ] 6. Release preparation: updated docs/build/verification/recovery notes and independent adversarial review.
